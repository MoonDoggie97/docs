...
<Tabs>
  ...
  <Tab title="BIOS Mode">
    ...
    **Steps:**
    ...
    ![Windows ISO Setup](https://3733328038-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FXLbPEl7L2saIrTjZharN%2Fuploads%2F71t5xmX3mNioJ4vl9VYa%2Fimage.png?alt=media&token=9b61f9bb-d41e-4c92-94f7-d05473b2a8ac)

    4. Once the ISO file is created, download [**Rufus**](https://rufus.ie/en/).
    5. Open Rufus and configure the following:
       - **Partition scheme:** GPT
       - **Target system:** UEFI (non-CSM)

    ![Rufus Setup](https://3733328038-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FXLbPEl7L2saIrTjZharN%2Fuploads%2F1N0AcDyVYNbtl60kyCwG%2Fimage.png?alt=media&token=ba843b84-5dc2-414a-81b6-e973c1116dea)
    ...
    ![CSM Disabled](https://3733328038-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FXLbPEl7L2saIrTjZharN%2Fuploads%2FvxhFehv40tNkDonb4xP1%2Fimage.png?alt=media&token=cf526a35-b81b-4b42-9678-178f2ce63042)
...
<Steps>
  <Step title="Install Launcher">
    Download and install the latest version of the launcher matching your product version to begin setup.

    - [Download Launcher Here](https://mega.nz/folder/zc8hXK7Y#IIIbhuCLlHe4CGRIVbErSw)
  </Step>
  <Step title="Extract Files">
    Use [WinRAR](https://www.win-rar.com/download.html) (or a similar tool) to extract the downloaded file.
  </Step>
  ...
  <Step title="System Restart">
    After entering your license key (available in your [Purchase History](https://hazcheats.com/clients/purchases/)), your PC will restart. This is expected.
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Blue Screen or PC Freezes After Launching the Game">
    1. Follow the guide here to use custom launch options.
    2. Add the following launch option: `-delay 120000`

    ![Batch Format](https://3733328038-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FXLbPEl7L2saIrTjZharN%2Fuploads%2FQhoLxpnCdrJhJFmdmKNv%2Fimage.png?alt=media&token=b4a5aa61-7bf3-4655-9abc-e5f2de31b1ea)

    _Replace LAUNCHER.exe with the correct file name_
  ...
  <Accordion title="More Error Codes">
    ...
    **0x86880004** — Your SVM & NX (Virtualization) mode are not enabled in BIOS.
